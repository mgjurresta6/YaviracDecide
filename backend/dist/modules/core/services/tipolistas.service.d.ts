...
export declare class TipoListasService {
    private tipolistaRepository;
    private cataloguesService;
    constructor(tipolistaRepository: Repository<TipoListaEntity>, cataloguesService: CataloguesService);
    ...
    removeAll(payload: TipoListaEntity[]): Promise<ServiceResponseHttpModel>;
}
