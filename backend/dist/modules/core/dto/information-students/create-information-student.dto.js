...
exports.CreateInformationStudentDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const entities_1 = require("../../entities");
class CreateInformationStudentDto {
...
], CreateInformationStudentDto.prototype, "isExecutedPractice", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", entities_1.CatalogueEntity)
], CreateInformationStudentDto.prototype, "isExecutedCommunity", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", entities_1.CatalogueEntity)
], CreateInformationStudentDto.prototype, "isDisability", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", entities_1.CatalogueEntity)
], CreateInformationStudentDto.prototype, "isLostGratuity", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", entities_1.CatalogueEntity)
], CreateInformationStudentDto.prototype, "isSubjectRepeat", void 0);
__decorate([
...
], CreateInformationStudentDto.prototype, "address", void 0);
__decorate([
...
], CreateInformationStudentDto.prototype, "community", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Debe ser un string' }),
    (0, class_validator_1.MaxLength)(255, { message: 'Maximo 255 caracteres' }),
    __metadata("design:type", String)
], CreateInformationStudentDto.prototype, "contactEmergencyName", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Debe ser un string' }),
    (0, class_validator_1.MaxLength)(255, { message: 'Maximo 255 caracteres' }),
    __metadata("design:type", String)
], CreateInformationStudentDto.prototype, "contactEmergencyKinship", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Debe ser un string' }),
    (0, class_validator_1.MaxLength)(255, { message: 'Maximo 255 caracteres' }),
    __metadata("design:type", String)
], CreateInformationStudentDto.prototype, "contactEmergencyPhone", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    (0, class_validator_1.Min)(0, { message: 'El número de digito mínimo es 0.' }),
    (0, class_validator_1.Max)(100, { message: 'Maximo 100 digito' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "disabilityPercentage", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    (0, class_validator_1.Min)(0, { message: 'El número de digito mínimo es 0.' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "educationalAmount", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    (0, class_validator_1.Min)(0, { message: 'El número de digito mínimo es 0.' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "economicAmount", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "familyIncome", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    (0, class_validator_1.Min)(1, { message: 'El número de digitos mínimo es 1.' }),
    (0, class_validator_1.Max)(20, { message: 'Maximo 20 digitos' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "membersHouseNumber", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Debe ser un string' }),
    (0, class_validator_1.MaxLength)(100, { message: 'Maximo 100 caracteres' }),
    __metadata("design:type", String)
], CreateInformationStudentDto.prototype, "postalCode", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    (0, class_validator_1.Min)(0, { message: 'El número de digito mínimo es 0.' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "practiceHours", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "scholarshipAmount", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'Debe ser tipo numero' }),
    (0, class_validator_1.Min)(0, { message: 'El número de digito mínimo es 0.' }),
    (0, class_validator_1.Max)(100, { message: 'Maximo 100 digito' }),
    __metadata("design:type", Number)
], CreateInformationStudentDto.prototype, "tariffScholarshipPercentage", void 0);
exports.CreateInformationStudentDto = CreateInformationStudentDto;
//# sourceMappingURL=create-information-student.dto.js.map