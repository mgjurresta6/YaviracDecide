...
class CatalogueDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { code: { required: true, type: () => String }, description: { required: true, type: () => String }, name: { required: true, type: () => String }, state: { required: true, type: () => String, enum: require("../../../../shared/enums/catalogue.enum").CatalogueStateEnum }, type: { required: true, enum: require("../../../../shared/enums/catalogue.enum").CatalogueTypeEnum } };
    }
}
__decorate([
