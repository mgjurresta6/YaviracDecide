...
var RolesService = /** @class */ (function () {
    function RolesService(repository) {
        this.repository = repository;
    }
    RolesService.prototype.create = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var newRole, roleCreated;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newRole = this.repository.create(payload);
                        return [4 /*yield*/, this.repository.save(newRole)];
                    case 1:
                        roleCreated = _a.sent();
                        return [2 /*return*/, { data: (0, class_transformer_1.plainToInstance)(dto_2.ReadRoleDto, roleCreated) }];
                }
            });
        });
    };
    RolesService.prototype.catalogue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RolesService.prototype.findAll = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { data: (0, class_transformer_1.plainToInstance)(dto_2.ReadRoleDto, role) }];
                }
            });
        });
    };
    RolesService.prototype.update = function (id, payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.save(role)];
                    case 2:
                        roleUpdated = _a.sent();
                        return [2 /*return*/, { data: (0, class_transformer_1.plainToInstance)(dto_2.ReadRoleDto, roleUpdated) }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.softRemove(role)];
                    case 2:
                        roleDeleted = _a.sent();
                        return [2 /*return*/, { data: (0, class_transformer_1.plainToInstance)(dto_2.ReadRoleDto, roleDeleted) }];
                }
            });
        });
    };
    RolesService.prototype.removeAll = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var rolesDeleted;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        rolesDeleted = _a.sent();
                        return [2 /*return*/, { data: rolesDeleted }];
                }
            });
        });
    };
    RolesService.prototype.paginateAndFilter = function (params) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (search) {
                            ...
                            page = 0;
                            where = [];
                            where.push({ code: (0, typeorm_1.ILike)("%".concat(search, "%")) });
