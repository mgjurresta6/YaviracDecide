...
exports.databaseProviders = [
    {
        ...
        useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, username, host, database, password, port, dataSource;
            return __generator(this, function (_b) {
                _a = configService.database, username = _a.username, host = _a.host, database = _a.database, password = _a.password, port = _a.port;
                ...
                return [2 /*return*/, dataSource.initialize()];
            });
        }); }
    },
];
